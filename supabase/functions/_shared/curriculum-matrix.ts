...
export const CURRICULUM_SUBJECTS: Record<Curriculum, string[]> = {
  ...
  IEB: [
    ...
    "Technical Mathematics", "Physical Sciences", "Technical Sciences",
    "Life Sciences", "English Home Language", "English First Additional Language",
    "Afrikaans", "IsiZulu First Additional Language", "History", "Geography",
    "Accounting", "Business Studies", "Economics", "Consumer Studies", "Tourism",
    "Computer Applications Technology", "Information Technology",
    "Engineering Graphics and Design", "Dramatic Arts", "Visual Arts", "Music",
    "Life Orientation",
  ],
  NSC: [
    "Mathematics", "Mathematical Literacy", "Technical Mathematics",
    "Physical Sciences", "Technical Sciences", "Life Sciences",
    "Agricultural Sciences", "English Home Language",
