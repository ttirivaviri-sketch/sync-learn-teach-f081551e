-- Seed verified curriculum topic template: NSC Grade 12 Accounting (CAPS)
-- Strand structure reflects the factual CAPS Grade 12 organisation:
-- companies (financial statements, analysis, audit), cash flow, inventory
-- systems, fixed assets, budgeting, cost accounting and internal control/
-- ethics (VAT included). All exemplar question stems are original
...
VALUES ('NSC', 'Grade 12', 'Accounting', $topics$
[
  {
