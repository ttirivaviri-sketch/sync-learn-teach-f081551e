-- Seed verified curriculum topic template: NSC Grade 12 Business Studies (CAPS)
-- Strand structure reflects the factual CAPS four-topic organisation:
-- business environments, business ventures, business roles and business
-- operations. All exemplar question stems are original compositions; no
...
VALUES ('NSC', 'Grade 12', 'Business Studies', $topics$
[
  {
