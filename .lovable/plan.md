...
2. Slide details:
   ...
   **School Workspaces**
   ...
   - CTA: "Explore school workspace" → navigate to `/learner/auth` (or relevant entry point for schools)
   - Accent: "purple"
   ...
   **Learning Operating System**
   ...
   - Bullets: "Mastery tracking across subjects", "Predictive gap alerts", "Automated next-action suggestions"
