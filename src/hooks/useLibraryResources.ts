...
const SEED_TUTORIALS: LibraryResource[] = [
  {
    ...
    rating: 4.9,
    reviews: 312,
    thumbnail: "https://i.ytimg.com/vi/IWigvJcCAJ0/hqdefault.jpg",
    isOffline: false,
    duration: "22 min",
    isTutorial: true,
    watchCount: 4210,
    completionRate: 87,
    // Verified live via YouTube oEmbed — Khan Academy: Introduction to the quadratic equation
    videoUrl: "https://www.youtube.com/watch?v=IWigvJcCAJ0",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 241,
    thumbnail: "https://i.ytimg.com/vi/F21S9Wpi0y8/hqdefault.jpg",
    isOffline: false,
    duration: "18 min",
    isTutorial: true,
    watchCount: 3890,
    completionRate: 82,
    // Old vimeo.com/76979871 link is 404 — replaced with Khan Academy: Basic Trigonometry (verified)
    videoUrl: "https://www.youtube.com/watch?v=F21S9Wpi0y8",
  ...
  },
  {
    ...
    watchCount: 2940,
    completionRate: 79,
    // Old loom.com link was a fake placeholder ID — replaced with CrashCourse: Newton's Laws (verified)
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 156,
    thumbnail: "https://i.ytimg.com/vi/nP0gDV0xDLY/hqdefault.jpg",
    isOffline: false,
    duration: "30 min",
    isTutorial: true,
    watchCount: 2100,
    completionRate: 75,
    // Was registered as a video with NO video URL (open failed with "No Video URL") — now linked (verified)
    videoUrl: "https://www.youtube.com/watch?v=nP0gDV0xDLY",
  ...
  },
  {
    ...
    watchCount: 1870,
    completionRate: 80,
    // Was registered as a video with NO video URL — now linked to CrashCourse: Photosynthesis (verified)
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 267,
    thumbnail: "https://i.ytimg.com/vi/yYX4bvQSqbo/hqdefault.jpg",
    isOffline: false,
    duration: "28 min",
    isTutorial: true,
    watchCount: 3100,
    completionRate: 83,
    // Was registered as a video with NO video URL — now linked to Accounting Stuff: Accounting Basics (verified)
    videoUrl: "https://www.youtube.com/watch?v=yYX4bvQSqbo",
...
const SEED_STUDY_SKILLS: LibraryResource[] = [
  ...
  },
  {
    ...
    watchCount: 0,
    completionRate: 0,
    // OpenStax renamed this PDF — old writing-guide-with-handbook URL now 403s (verified replacement)
    videoUrl: "https://assets.openstax.org/oscms-prodcms/media/documents/WritingGuide-WEB.pdf",
    pdfSource: "system",
  ...
  },
  {
    ...
    watchCount: 0,
    completionRate: 0,
    // OpenStax renamed this PDF — old psychology-2e URL now 403s (verified replacement)
    videoUrl: "https://assets.openstax.org/oscms-prodcms/media/documents/Psychology2e_WEB.pdf",
    pdfSource: "system",
