...
import { AI_VIRUS_POST } from "@/content/blogPosts";
import { AI_VIRUS_ARTICLE_HTML, ARTICLE_SECTIONS } from "@/content/aiVirusArticleHtml";

const Footer = lazy(() => import("@/components/Footer"));
const post = AI_VIRUS_POST;
...
const articleJsonLd = JSON.stringify({
  ...
  image: `${SITE_URL}/og/ai-cure-or-incurable-virus.jpg`,
...
const AiVirusArticle = () => (
  <div className="min-h-screen bg-background">
    <Seo
      title="AI: Cure for the Lack of Intelligence, or Incurable Virus?"
      description="From viruses to malware to autonomous AI: what the OpenAI–Hugging Face incident reveals about a pattern history has shown three times."
      path={post.path}
    ...
    <Helmet>
      ...
      <meta property="article:section" content="AI and society" />
          ...
          <div className="mx-auto max-w-6xl px-4 pb-12 pt-8 sm:px-6 sm:pb-16 sm:pt-10 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-7 max-w-3xl text-xl leading-8 text-muted-foreground sm:text-2xl sm:leading-9">
                Biology, software and now silicon have each taught the same lesson about self-replicating
                systems. The question is whether it will be learned in time.
              </p>
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <figure>
            ...
            <figcaption className="mt-3 text-sm text-muted-foreground">
              From the code of life to the code that writes itself: the same architecture, and the same hazard, three times over.
            </figcaption>
          </figure>
          ...
          <div className="mt-12 grid gap-12 lg:grid-cols-[220px_minmax(0,720px)] lg:justify-center">
            ...
            <div className="min-w-0 text-[1.05rem] leading-8 text-foreground/85 [&_h2]:scroll-mt-8 [&_h2]:pt-8 [&_h2]:text-3xl [&_h2]:font-extrabold [&_h2]:leading-tight [&_h2]:text-foreground [&_p]:mt-5">
              ...
              <div dangerouslySetInnerHTML={{ __html: AI_VIRUS_ARTICLE_HTML }} />

              <section className="mt-12 rounded-lg bg-foreground p-7 text-background sm:p-9" aria-labelledby="virus-try-heading">
                <p className="text-xs font-bold uppercase text-secondary-light">Think critically with StudySync</p>
                <h2 id="virus-try-heading" className="mt-3 pt-0 text-2xl text-background sm:text-3xl">Learn to interrogate AI, not just use it</h2>
                <p className="text-background/70">StudySync pairs curriculum-aligned practice with guided AI feedback and real tutors, so learners in South Africa and Zimbabwe build the judgement this era demands.</p>
