...
const steps: Step[] = [
  {
    ...
    description: "Pick your curriculum, grade and subjects",
  },
  {
    number: 2,
    icon: FileText,
    title: "Set your",
    subtitle: "exam dates",
    description: "We build a study plan around your countdown",
  },
  {
    number: 3,
    icon: ListChecks,
    title: "Study daily",
    subtitle: "with AI",
    description: "Adaptive tasks, quizzes, photo solve and mock exams",
    highlighted: true,
  },
  {
    number: 4,
    ...
    title: "Book a tutor",
    subtitle: "when stuck",
    description: "Verified experts for the topics AI flags as weak",
  },
  {
    number: 5,
    icon: Users,
    title: "Watch your",
    subtitle: "grades climb",
    description: "Weekly progress proof and predicted grades",
  },
];
