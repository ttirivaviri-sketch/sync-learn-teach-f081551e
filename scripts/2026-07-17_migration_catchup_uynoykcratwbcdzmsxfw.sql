...
--     1. Idempotently (re)applies all 11 repo migrations newer than
...
-- ============================================================================
-- === MIGRATION: 20260717130000 (merge_permissive_policies)
-- ============================================================================
...
begin
  ...
  values
    ...
    ('20260717130000', 'merge_permissive_policies')
  on conflict (version) do nothing;
  raise notice 'History repair complete: schema_migrations now includes all versions through 20260717130000.';
exception
...
-- 1. Migration history should now end at 20260717130000 (13 newest rows).
select version, name
